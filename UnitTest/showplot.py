...
test_matrix3 = np.loadtxt(open("E:\OneDrive\Python\BHand\Data\Ragdoll\RD01S2.csv","rb"),delimiter=",",skiprows=0)
none = np.loadtxt(open("E:\OneDrive\Python\BHand\Data\None\N01S1.csv","rb"),delimiter=",",skiprows=0)
