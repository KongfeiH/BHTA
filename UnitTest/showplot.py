...
show = DS()
test_matrix = np.loadtxt(open("C:\Users\hekon\Desktop\T.csv","rb"),delimiter=",",skiprows=0)
test_matrix1 = np.loadtxt(open("C:\Users\hekon\Desktop\T.csv","rb"),delimiter=",",skiprows=0)
...
show.PlotShow(test_matrix,test_matrix,test_matrix2,test_matrix3)