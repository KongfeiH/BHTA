...
class ftsstr:
    ...
    def update(self):
        ...
        val = val if val < 0x8000 else hand.twoscomp(val, 16)
        ...
        self.Force = [self.forceX, self.forceY, self.forceZ, self.torqueX, self.torqueY, self.torqueZ]
        # print "FT DATA"
    ...
    def tare(self):
        ...
        Tare the FTS sensor.
        '''
        bt.set_property(hand.FTS, hand.FTS_FT, 0)
        self.error_byte = 0
    ...
    def initialize_fts(self):
        ...
        '''
        hand.set_property(hand.FTS, hand.STAT, 2)
        hand.set_property(hand.FTS, hand.FTS_FT, 0)
    ...
    def read_ftdata(self):
        ...
        '''
        hand.can_reset()
        err = hand.write_msg(hand.FTS, [hand.FTS_FT])
